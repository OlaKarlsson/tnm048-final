function paralellChart() {
  ...
  this.update = function (rawData, selected) {
    ...
    var foreground = svg.append("g")
      ...
      .style("stroke", function (d) {
        return colours[d["bechdel_rating"]];//Get the colour by using the country-name as key
      })
  ...
  //     cc[d[" bechdel_rating "]] = colours(d[" bechdel_rating "]); //Fill the array with country names and their associated colours
